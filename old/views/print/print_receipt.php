...
<div class="py-3">
   <table class="table table-bordered" align="center" width="100%" height='100%'>
       <thead>
           <tr>
               <th colspan="5" rowspan="2" style="padding-left: 15px;">Guarantor Name</th>
               <th colspan="5" rowspan="2" style="padding-left: 15px;">Guarantor Phone</th>
       ...
       <tbody>
           <tr>
               ...
               {
                   ?>
                   <td  colspan="5" rowspan="2" style="padding-left: 15px;"><?= $row['guarantor_name']; ?></td>
                   <td  colspan="5" rowspan="2" style="padding-left: 15px;"><?= $row['guarantor_phone']; ?></td>
                   <?php
               }
               ?>
           </tr>
